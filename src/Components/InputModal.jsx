    ...
    const ordersCollection = collection(db, "orders");
      addDoc(ordersCollection, order).then(({ id }) =>
        Notiflix.Report.success(
          '¡CONTRATO CREADO!',
          `Su numero de su registro es: ${id}`,
          'Entendido!',
          {
            width: '360px',
            svgSize: '120px',
